...
It is common for the components of a research object to be managed separately with code in one repository, data on a shared drive, environment setup in a wiki page, provenance in a lab notebook or nowhere at all.
This fragmentation undermines rigor, reproducibility, reusability, and efficiency.
...
But the community lacks a shared vocabulary for referring to these ideas, evaluating how thoroughly they are applied, and communicating that evaluation to collaborators and reviewers.
