...
\subsection{Lit Review AKA Reflection on the past/existing efforts}

% "Convergent evolution" ...

% now that we provided a very brief intro, and then presented the
% desired STAMPED principles, we want to reflect back better on what
% had been developed and used in the field ATM and potentially relate
% to the STAMPED properties.
...
Although [TODO: find some oldest work which could relate to organization of research objects], since 2000, various initiatives emerged formalizing various aspects of the scientific research workflow aiming to improve clarity, efficiency, reproducibility, sharing and other aspects. Here we are not aiming for a comprehensive overview of the approaches but rather relating them to accent on the importance of various STAMPED properties.

\textbf{Data and metadata organization}: Noble's 2009 guidelines for organizing projects in computational biology organization\cite{noble_quick_2009} potentially pioneered formalization of pragmatic   [TODO relate to BIDS],

\textbf{Foundational principles}:  FAIR principles for scholary data management and sharing\cite{wilkinson_fair_2016}, Software Carpentry's ``Good Enough Practices''\cite{wilson_good_2017}.

\textbf{Data-oriented content tracking \& version control}: git-annex (2010), Git LFS (2015), DVC (2017), Pachyderm (2014), Quilt (2020s), Icechunk (2024) etc, all independently arrived at ``Git for data'' concepts, applying proven content control semantics to large datasets.

\textbf{Cloud platforms}: Code Ocean (2017), brainlife.io (2017), Flywheel (2018), Galaxy (2005) and others provided turnkey reproducibility services, all implementing code/environment/data trinity separation.

\textbf{Framework tooling}: Cookiecutter Data Science (2016), Kedro (2019), nipoppy (2023) etc.  provided opinionated and domain-specific composition of organizational principles along with operational frameworks to facilitate complete data processing workflows.
...
\textbf{Metadata standards}: W3C-PROV (???), Frictionless data (???), RO-Crate (2019), BioComputeObject (IEEE 2791-2020) address packaging and provenance standardization.
