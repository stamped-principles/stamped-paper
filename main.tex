...
What is still missing is a shared vocabulary for how a research object, a complete unit of data, code, and metadata, should be structured and managed so it can be re-executed, extended, and redistributed; FAIR and FAIR4RS address discovery and reuse, but not this operational layer.
