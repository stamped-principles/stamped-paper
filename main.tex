...
Virtual machines provide full system-level isolation; container-based tools (Docker, Singularity/Apptainer) bundle OS-level environments; declarative package managers (Nix, Guix) specify environments that can be reconstructed from a definition.
...
The FAIRly big workflow\cite{wagner_fairly_2022} and other approaches to using Distributed!(D) computing platforms such as SLURM or Code Ocean operationalize this ideal, treating each computation as an ephemeral work unit.
