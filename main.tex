...
It is common for the components of a research object to be organized independently---code in one repository, data on a shared drive, environment setup in a wiki page, provenance in a lab notebook or nowhere at all---and this separation undermines rigor, reproducibility, reusability, and efficiency.
...
The Workflow Community Initiative (WCI-FW)\cite{wilkinson_applying_2025} mapped these principles % We are assuming that the reader knows findable, accessible, interoperable, and reusable are the FAIR principles, and we are referring to the FAIR principles here.
