...
Previous approaches to this govern digital objects in general but leave the operational layer between them without a shared vocabulary for how a research object, as a complete unit, should be structured and managed so it can be re-executed, extended, and redistributed.
