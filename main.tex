...
At the practical baseline, a research object that has all components under one project directory, includes version-controlled analysis scripts, and contains documentation on how to run them meets the requirements for Self-containment, Tracking, and Actionability.
