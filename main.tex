...
We adopt the term \textbf{research object} to denote a collection of data, code, and metadata that together represent the research output as a unit.  % This definition of research object is still a bit problematic to me. While a research object is supposed to be the representation of the research output, but data, code, and metadata seem like mostly are the "inputs" to a research. Additionally, tools such as datalad capture both the inputs and output results of a research, so I think your intended definition of a research object must represent both inputs and outputs of a research.
