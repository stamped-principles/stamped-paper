...
Throughout the manuscript we will refer to such content tracking systems as VCS to use terminology familiar to the reader, although some initiatives such as \cite{johnson_sciops_2024} would describe such requirement as data consistency.
...
Defining a module as a separately distributable collection of components for our research object, \textbf{Modularity} is achieved when all modules of the research are independent and composable.
