...
It is common for the components of a research object to be stored separately---code in one repository, data on a shared drive, environment setup in a wiki page, provenance in a lab notebook or nowhere at all---and this separation undermines rigor, reproducibility, reusability, and efficiency.
