...
Table~\ref{tab:stamped-tools} maps commonly used tools and technologies to each STAMPED property.
The principle is tool-agnostic — any system that moves a property from documented to executable moves the research object further along the actionability spectrum — but certain tool categories recur across multiple properties, reinforcing that a well-chosen toolchain can address several dimensions at once.
...
Make, Snakemake, Nextflow, CWL, \texttt{datalad run} &
